...
const unifiedBookingSchema = {
  taxi: {
    ...
    status: "status", invoiceTable: "invoice", invoiceAmount: "sub_total",
  ...
  bus: {
    ...
    status: "status_spoc", invoiceTable: "bus_invoice", invoiceAmount: "sub_total",
  ...
  train: {
    ...
    status: "booking_status", invoiceTable: "train_invoice", invoiceAmount: "sub_total",
    assigned: "is_assign", cancelled: "is_cancelled", childKey: "master_booking_id",
  },
  flight: {
    ...
    status: "status", invoiceTable: "flight_invoice", invoiceAmount: "sub_total",
    assigned: "is_assign", cancelled: "is_cancelled", childKey: "master_booking_id",
  },
  hotel: {
    ...
    invoiceTable: "hotel_invoice", invoiceAmount: "sub_total", assigned: "is_assign",
  ...
  visa: {
    ...
    invoiceAmount: null, assigned: null, cancelled: null, childKey: null,
