...
const unifiedBookingSchema = {
  ...
  bus: {
    ...
    status: "status_spoc", invoiceTable: "bus_invoice", invoiceAmount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceStatus: "status",
  ...
  train: {
    ...
    status: "booking_status", invoiceTable: "train_invoice", invoiceAmount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceStatus: "status",
    assigned: "is_assign", cancelled: "is_cancelled", childKey: "master_booking_id",
  },
  flight: {
    ...
    status: "status", invoiceTable: "flight_invoice", invoiceAmount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceStatus: "status",
    assigned: "is_assign", cancelled: "is_cancelled", childKey: "master_booking_id",
  },
  hotel: {
    ...
    invoiceTable: "hotel_invoice", invoiceAmount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceExtraFees: "tax_on_room", invoiceStatus: "status", assigned: "is_assign",
