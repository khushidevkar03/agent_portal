const recentActivitySchema = {
  taxi: {
    ...
    invoiceTable: "invoice", amount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceExtraFees: "tax", assigned: "is_assign", childKey: "master_booking_id", cancelled: null,
  },
  bus: {
    ...
    invoiceTable: "bus_invoice", amount: "sub_total", invoiceFees: "taxivaxi_tax_charge", assigned: "is_assign", childKey: "master_booking_id", cancelled: "is_cancelled",
  },
  train: {
    ...
    invoiceTable: "train_invoice", amount: "sub_total", invoiceFees: "taxivaxi_tax_charge", assigned: "is_assign", childKey: "master_booking_id", cancelled: "is_cancelled",
  },
  flight: {
    ...
    invoiceTable: "flight_invoice", amount: "sub_total", invoiceFees: "taxivaxi_tax_charge", assigned: "is_assign", childKey: "master_booking_id", cancelled: "is_cancelled",
  },
  hotel: {
    ...
    invoiceTable: "hotel_invoice", amount: "sub_total", invoiceFees: "taxivaxi_tax_charge", invoiceExtraFees: "tax_on_room", assigned: "is_assign", childKey: "master_booking_id", cancelled: "is_cancelled",
  },
  visa: {
